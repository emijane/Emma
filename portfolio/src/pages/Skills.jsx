...
export default function Skills() {
    return (
      <div className="skills border border-pink-200/30 text-gray-300 mt-[1rem] p-[3.2rem] bg-[rgba(107,114,128,0.1)] md:rounded-2xl
          ...
          <div className="skills-list mt-[1.5rem] max-w-[50rem]">
            <li className="flex flex-wrap gap-3">
              {['HTML5', 'CSS3', 'JavaScript (ES6+)', 'TypeScript', 'React.js', 'Tailwind CSS', 'Sass', 'Git/GitHub', 'Node.js', 'Vite', 'Python', 'Webpack', 'gulp.js', 'Figma', 'Adobe Photoshop', 'Adobe After Effects', 'npm'].map((skill) => (
                <a key={skill} className="skill-tag text-xs border border-pink-300/50 rounded-xl shadow-lg hover:shadow-2xl transform-gpu will-change-transform transform hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 hover:border-pink-300 p-2">
                  {skill}
                </a>
              ))}
            </li>
