...
export default function Projects() {
  return (
    <div className="projects border border-pink-200/30 text-gray-300 mt-4 p-6 max-w-[60rem] bg-[rgba(107,114,128,0.1)] md:rounded-lg text-gray-300 mt-[1rem] p-[2rem] bg-[rgba(107,114,128,0.1)] md:rounded-lg
