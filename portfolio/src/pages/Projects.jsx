...
export default function Projects() {
  return (
    <div className="projects border border-pink-200/30 text-gray-300 mt-4 bg-[rgba(107,114,128,0.1)] text-gray-300 mt-[1rem] md:mt-[2rem] p-[3.2rem] bg-[rgba(107,114,128,0.1)] md:rounded-2xl
